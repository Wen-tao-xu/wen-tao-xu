...
function createMap() {
    ...
    var point = new BMap.Point(119.642664, 29.068308); //定义一个中心点坐标
...
showMap.onclick=function(e){
     e.stopPropagation();
    if (locationMap.style.height=="680px") {
        locationMap.style.height="0px";
        locationMap.style.opacity="0";
    }else{
        locationMap.style.height="680px";
        locationMap.style.opacity="1";
        moreList.style.height="0";//顶部下拉菜单收回
